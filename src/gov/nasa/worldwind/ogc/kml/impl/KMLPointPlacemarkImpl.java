...
public class KMLPointPlacemarkImpl extends PointPlacemark implements KMLRenderable
{
    ...
    protected boolean mustRefreshIcon()
    {
        ...
        KMLIconStyle iconStyle = (KMLIconStyle) this.parent.getSubStyle(new KMLIconStyle((String)null), mode);
        //X-END
    ...
    protected PointPlacemarkAttributes makeAttributesCurrent(String attrType)
    {
        ...
        //X-PATCH Marjan
        //casting null to String because of overloaded constructor
        KMLAbstractSubStyle subStyle = this.parent.getSubStyle(new KMLLineStyle((String)null), attrType);
        //X-END
        ...
        //X-PATCH Marjan
        //casting null to String because of overloaded constructor
        subStyle = this.parent.getSubStyle(new KMLIconStyle((String)null), attrType);
        //X-END
        if (subStyle.hasFields() && (!this.isHighlighted() || KMLUtil.isHighlightStyleState(subStyle)))
        {
            hasIconStyle = true;
        ...
        //X-PATCH Marjan
        //casting null to String because of overloaded constructor
        subStyle = this.parent.getSubStyle(new KMLLabelStyle((String)null), attrType);
        //X-END
        if (subStyle.hasFields() && (!this.isHighlighted() || KMLUtil.isHighlightStyleState(subStyle)))
        {
            hasLabelStyle = true;
