...
public class KMLLink extends KMLAbstractObject
{
    ...
    public KMLLink(KMLLink orig)
    {
        super(orig);
        setField("href", orig.getHref());
        setField("refreshMode", orig.getRefreshMode());
        setField("refreshInterval", orig.getRefreshInterval());
        setField("viewRefreshMode", orig.getViewRefreshMode());
        setField("viewRefreshTime", orig.getViewRefreshTime());
        setField("viewBoundScale", orig.getViewBoundScale());
        setField("viewFormat", orig.getViewFormat());
        setField("httpQuery", orig.getHttpQuery());
    }
    //X-END
