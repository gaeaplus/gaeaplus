...
public class KMLIconStyle extends KMLAbstractColorStyle
{
    ...
    public KMLIconStyle(KMLIconStyle orig)
    {
        super(orig);
        setField("scale", orig.getScale());
        setField("heading", orig.getHeading());
        setField("hotSpot", orig.getHotSpot() == null
                ? null : new KMLVec2(orig.getHotSpot()));
        setField("Icon", orig.getIcon() == null
                ? null : new KMLIcon(orig.getIcon()));
    }
    //X-END
