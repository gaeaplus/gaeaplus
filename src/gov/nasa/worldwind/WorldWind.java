...
import gov.nasa.worldwind.retrieve.ImmediateRetrievalSrvice;
...
public final class WorldWind
{
    ...
    //X-START
	private boolean isImmediateMode = false;
    private GLTaskService glTaskService;
	private ThreadedCalcTaskService calcTaskService;
	private TaskService taskServiceImmediate;
    private RetrievalService retrievalServiceImmediate;
	//X-END
    ...
    private void initialize()
    {
        ...
        //X-START
		//Vito
		//immediate task service added
        //immediate task service is used for recording
		this.retrievalServiceImmediate = new ImmediateRetrievalSrvice();
		this.taskServiceImmediate = new ImmediateTaskService();
        this.calcTaskService = new ThreadedCalcTaskService();
		//task service with gl context
		this.glTaskService = new GLTaskService();
		//X-END
    ...
    private void dispose()
    {
        ...
        //X-START
        //Vito
        //dispose new calc task service
        //immediate task service don't need to be disposed, becouse they are not threaded! 
		if (this.calcTaskService != null)
			this.calcTaskService.shutdown(true);
		//X-END
    }
    ...
    public static RetrievalService getRetrievalService()
    {
		...
		//immediate task service added
        //immediate task service is used for recording
		if(instance.isImmediateMode){
			return instance.retrievalServiceImmediate;
		}
    ...
    public static TaskService getTaskService()
    {
        ...
        //immediate task service is used for recording
		if(instance.isImmediateMode){
			return instance.taskServiceImmediate;
		}
    ...
    //X-START
    //Vito
    public static GLTaskService getGLTaskService()
    {
        return instance.glTaskService;
    }
    
    public static ThreadedCalcTaskService getCalcTaskService(){
		return instance.calcTaskService;
	}
    
	public static void setImmediateMode(boolean enable){
		instance.isImmediateMode = enable;	
	}
    //X-END
