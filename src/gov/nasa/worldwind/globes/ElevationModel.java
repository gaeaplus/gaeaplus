 ...
 *
 * @author Tom Gaskins
 * @version $Id: ElevationModel.java 1171 2013-02-11 21:45:02Z dcollins $
 */
public interface ElevationModel extends WWObject, Restorable, Disposable
{
	...
	//Vito
	 ...
	 /**
     * Returns the exact elevation at a specified location, but without mapping missing data to the elevation model's missing
     ...
     *         returned.
     */
    double getExactElevation(Angle latitude, Angle longitude);

    /**
     * Returns the exact elevation at a specified location, but only exact to a specified resolution.
     * If elevation values of higher resolution exist, they can be used instead.
     * @param latitude  The latitude of the location for which to return the elevation.
     * @param longitude The latitude of the location for which to return the elevation.
     * @param targetResolution  The desired resolution of elevation, specified in radians.
     * @return The elevation at the specified location, or the elevation model's missing data signal. If no data is
     *         currently available for the location, the elevation model's global minimum elevation at that location is
     *         returned.
     */
    double getExactElevation(Angle latitude, Angle longitude, double targetResolution);
     ...
     */
    double getElevationsImmediate(Sector sector, List<? extends LatLon> latlons, double targetResolution, double[] buffer);
