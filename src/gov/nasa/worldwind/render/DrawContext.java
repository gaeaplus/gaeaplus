...
//    void setGroupingFilters(Map<String, GroupingFilter> filters);
     ...
     */
	void setRecordingMode(boolean enable);

	/**
     * This method should only be used in AbstractSceneController.
     */
     ...
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	void setDefferedRenderer(DeferredRenderer dr);

	/**
     * ShaderContext is used to create and manipulate CG and GLSL shaders.
     *
     ...
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	void setShaderContext(ShaderContext sc);
	...
	/**
     * Returns true if shadows are currently visible, otherwise return false
     *
     * @return true if shadows are currently visible, otherwise false
     */
     ...
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	void setShadowsEnabled(boolean enable);
     ...
     */
	boolean isSunLightEnabled();

	/**
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	void setSunLightEnabled(boolean enable);
     ...
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	void setAtmosphereEnabled(boolean enable);

	boolean isAerialPerspectiveEnabled();
