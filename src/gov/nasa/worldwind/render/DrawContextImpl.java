...
//    protected Map<String, GroupingFilter> groupingFilters;
    ...
    private boolean isShadowsEnabled = false;
	...
	*/
    ...
    public void dispose()
    {
        ...
        //X-START
        //Vito
        this.framebufferController.dispose();
		this.sc = null;
        //X-END
    }
    ...
    public final void initialize(GLContext glContext)
    {
        ...
        //X-START
		//Vito
		this.framebufferController.init(this);
		//X-END
...
//    }
     ...
     */
	public FrameBufferController getFramebufferController(){
		return this.framebufferController;	
	}

	/**
     * Deferred renderer is used for offscreen rendering and splitting 
	 * rendered data to color/depth/normal/material... components
     *
     * @return FramebufferState
     */
     ...
     */
	public void setDefferedRenderer(DeferredRenderer dr){
		this.deferredRenderer = dr;
	}
	
	public ShaderContext getShaderContext(){
		return this.sc;
	}

	public void setShaderContext(ShaderContext sc){
		this.sc = sc;
		if(this.sc != null){
			this.sc.apply(this);
		}
     ...
     *
     * @return true for recording mode, otherwise false
     */
	...
	/**
     * Don't set this parameter. This method should only be used in AbstractSceneController.
	 * Use NbPreferences to set this value!
     */
	public void setRecordingMode(boolean enable){
		this.isRecordingMode = enable;
	}

	/**
     * Returns true if the Shadow mode is active, otherwise return false
     *
     * @return true for Shadow mode, otherwise false
     */
	...
	/**
     * Returns true if shadows are enabled, otherwise return false
     *
	...
	public void setShadowsEnabled(boolean enable){
		this.isShadowsEnabled = enable;
	}

	/**
     * Returns true if atmosphere is enabled, otherwise return false
     *
     * @return true if atmosphere is enabled, otherwise false
     */
	public boolean isAtmosphereEnabled(){
		return isAtmosphereEnabled;
	}

	/**
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	public void setAtmosphereEnabled(boolean enable){
		this.isAtmosphereEnabled = enable;
	}
     ...
     */
	public boolean isAerialPerspectiveEnabled(){
		return isAerialPerspectiveEnabled;
	}
	...
	/**
     * Returns true if sun light is enabled, otherwise return false
     *
     * @return true if sun light is enabled, otherwise false
     */
     ...
     * Don't set this parameter. This method should only be used in AbstractSceneController.
     */
	public void setSunLightEnabled(boolean enable){
		this.isSunLightEnabled = enable;
	}
	...
	public float getExposure(){
		...
		//TODO: check for errors and null objects!
		Vec4 eye = this.getView().getEyePoint();

		double eR = this.getGlobe().getRadiusAt(this.getView().getEyePosition());
