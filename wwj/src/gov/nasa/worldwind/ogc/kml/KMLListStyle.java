...
public class KMLListStyle extends KMLAbstractSubStyle
{
    ...
    public KMLListStyle(KMLListStyle orig)
    {
        super(orig);
        setField("listItemType", orig.getListItemType());
        setField("bgColor", orig.getBgColor());
        for (KMLItemIcon o: orig.getItemIcons())
            itemIcons.add(o);
        setField("maxSnippetLines", orig.getMaxSnippetLines());
    }
    //X-END
