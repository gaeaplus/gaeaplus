...
public class KMLBalloonStyle extends KMLAbstractSubStyle
{
    ...
    public KMLBalloonStyle(KMLBalloonStyle orig)
    {
        super(orig);
        setField("color", orig.getColor());
        setField("bgColor", orig.getBgColor());
        setField("textColor", orig.getTextColor());
        setField("text", orig.getText());
        setField("displayMode", orig.getDisplayMode());
    }
    //X-END
