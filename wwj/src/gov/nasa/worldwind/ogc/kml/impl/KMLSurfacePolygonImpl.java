...
public class KMLSurfacePolygonImpl extends SurfacePolygon implements KMLRenderable
{
    ...
    protected ShapeAttributes makeAttributesCurrent(String attrType)
    {
        ...
        KMLAbstractSubStyle lineSubStyle = this.parent.getSubStyle(new KMLLineStyle((String)null), attrType);
        //X-END
        ...
        //X-PATCH Marjan
        //casting null to String because of overloaded constructor
        KMLAbstractSubStyle fillSubStyle = this.parent.getSubStyle(new KMLPolyStyle((String)null), attrType);
        //X-END
        if (!this.isHighlighted() || KMLUtil.isHighlightStyleState(lineSubStyle))
        {
