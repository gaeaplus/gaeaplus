...
public class PerformanceStatistic implements Comparable<PerformanceStatistic>
{
	...
	//Vito
	//mesure render times
    public static final String RENDER_TIME_CPU = "gov.nasa.worldwind.perfstat.RenderTimeCpu";
    public static final String RENDER_TIME_GPU = "gov.nasa.worldwind.perfstat.RenderTimeGpu";
	//X-END
