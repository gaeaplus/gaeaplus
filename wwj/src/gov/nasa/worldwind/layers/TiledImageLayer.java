...
//                }
	...
	//X-START
	//Vito
	//Method for creating <code>TextureTile</code>.
	//Classes that extends <code>TiledImageLayer</code> can override this method and    
	protected TextureTile createTile(Sector sector, Level targetLevel, int row, int col){
		return new TextureTile(sector, targetLevel, row, col);
	} 
	//X-END
